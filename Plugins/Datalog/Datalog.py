...
async def water_get(args, LogPath, event: MessageEvent, bot:Bot) -> Message:
    ...
    if isinstance(event, GroupMessageEvent):
        ...
        if args == 'list':  # 排行榜查询
            ...
            return_msg = (
                ...
                +MessageSegment.text("查询对象：")+MessageSegment.at(event.user_id)+MessageSegment.text("\n")
...
async def add_number_of_water(memdic, LogPath, bot: Bot, event: GroupMessageEvent) -> None:
